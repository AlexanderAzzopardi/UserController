...
namespace sample.microservice.useraccount.Controllers
{
    ...
    {
        [HttpPost("add")]
        public async Task<ActionResult<Guid>> AddUser(Account account, [FromServices] DaprClient daprClient)
        {
            try
            {
        ...
        [HttpPost("delete")]
        public async Task<ActionResult<Guid>> DeleteUser(Account account, [FromServices] DaprClient daprClient)
        {    
            try
            {   
                var client = new DaprClientBuilder().Build();
        ...
        [HttpPost("get")]
        public async Task<ActionResult<Guid>> GetUser(Account account, [FromServices] DaprClient daprClient)
        {  
            try
            {   
                var client = new DaprClientBuilder().Build();
        ...
        [HttpPost("check")]
        public async Task<ActionResult<int>> CheckUser([FromServices] DaprClient daprClient)
        {  
            try
            {   
                var client = new DaprClientBuilder().Build();
